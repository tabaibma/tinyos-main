...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b33fe8801f0, const void *arg_0x2b33fe8804c8);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 252
extern double erfc(double arg_0x2b33fe9029c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x2b33feb50868), 
int (*key_eq_fn)(void *arg_0x2b33feb4f020, void *arg_0x2b33feb4f2c0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b33fed3f288, int arg_0x2b33fed3f4f0);
static double RandomUniform(void );
...
#line 71
static inline uint16_t BBConstructionC$hasWhiteNeighbors(void );
#line 84
...
#line 121
{
  if (BBConstructionC$my_color[sim_node()] == WHITE) {
      ...
      sim_log_debug_clear(151U, "BBConstructionCStream", "%d %d\n", nodeid, TOS_NODE_ID);
...
# 78 "/home/ubuntu1204/Dropbox/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b33ff147340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b33ff147340) {
#line 78
    case 7:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b33ff147340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/ubuntu1204/Dropbox/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b33ff175020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b33ff175020, msg, payload, len);
#line 78
...
#line 59
{
  if (err == SUCCESS) {
      ...
      BBConstructionC$HelloTimer$startPeriodic(200 + TOS_NODE_ID * 5);
    }
  else {
...
# 110 "/home/ubuntu1204/Dropbox/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b33ff149220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b33ff149220, msg, error);
#line 110
}
#line 110
...
# 100 "/home/ubuntu1204/Dropbox/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b33ff39f318, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b33ff39f318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b33ff39f318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/ubuntu1204/Dropbox/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b33fee60ab0){
#line 75
  switch (arg_0x2b33fee60ab0) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b33fee60ab0);
#line 75
      break;
#line 75
    }
...
# 83 "/home/ubuntu1204/Dropbox/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b33ff613da0){
#line 83
  switch (arg_0x2b33ff613da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b33ff613da0);
#line 83
      break;
#line 83
    }
...
#line 126
# 80 "/home/ubuntu1204/Dropbox/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b33ff39e488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b33ff39e488, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(152U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(153U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(154U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(155U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
