...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x2ab7a9ba4cf8, const void *arg_0x2ab7a9ba3020);
#line 775
__extension__ 
#line 792
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2ab7a9e758e8), 
int (*key_eq_fn)(void *arg_0x2ab7a9e730c8, void *arg_0x2ab7a9e73368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2ab7aa084610, int arg_0x2ab7aa084878);
static inline double RandomUniform(void );
...
static void SimpleC$Boot$booted(void );
...
# 6 "SimpleC.nc"
static inline void SimpleC$Boot$booted(void );
# 62 "/home/tharun/tinyos-main/tos/interfaces/Init.nc"
...
enum SimSchedulerBasicP$__nesc_unnamed4294 {

  SimSchedulerBasicP$NUM_TASKS = 3U, 
...
static inline void SimSchedulerBasicP$sim_scheduler_submit_event(void );
...
enum TossimPacketModelC$__nesc_unnamed4295 {
#line 96
...
enum TossimPacketModelC$__nesc_unnamed4296 {
#line 101
...
#line 145
enum TossimPacketModelC$__nesc_unnamed4297 {
#line 145
...
# 78 "/home/tharun/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2ab7aa473480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2ab7aa473480, msg, payload, len);
#line 78
...
# 78 "/home/tharun/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2ab7aa475908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2ab7aa475908, msg, payload, len);
#line 78
...
# 69 "/home/tharun/tinyos-main/tos/lib/tossim/SimSchedulerBasicP.nc"
static inline int SimSchedulerBasicP$sim_config_task_latency(void )
#line 69
{
#line 69
...
# 110 "/home/tharun/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2ab7aa461778, message_t * msg, error_t error){
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x2ab7aa461778, msg, error);
#line 110
}
#line 110
...
# 75 "/home/tharun/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2ab7aa186108){
#line 75
  switch (arg_0x2ab7aa186108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2ab7aa186108);
#line 75
      break;
#line 75
    }
