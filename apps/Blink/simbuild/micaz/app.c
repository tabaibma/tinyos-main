...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x2ac411dcacf8, const void *arg_0x2ac411dd5020);
#line 775
__extension__ 
#line 792
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2ac41209c8e8), 
int (*key_eq_fn)(void *arg_0x2ac41209a0c8, void *arg_0x2ac41209a368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2ac4122ab610, int arg_0x2ac4122ab878);
static inline double RandomUniform(void );
...
# 67 "/home/ubuntu1310/tinyos-main/tos/interfaces/Leds.nc"
...
# 78 "/home/ubuntu1310/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2ac41269c020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2ac41269c020, msg, payload, len);
#line 78
...
# 78 "/home/ubuntu1310/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2ac41269d340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2ac41269d340, msg, payload, len);
#line 78
...
# 110 "/home/ubuntu1310/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2ac41269e220, message_t * msg, error_t error){
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x2ac41269e220, msg, error);
#line 110
}
#line 110
...
# 75 "/home/ubuntu1310/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2ac4123ac108){
#line 75
  switch (arg_0x2ac4123ac108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2ac4123ac108);
#line 75
      break;
#line 75
    }
...
#line 42
# 84 "/home/ubuntu1310/tinyos-main/tos/system/LedsP.nc"
static inline void LedsP$Leds$led0Toggle(void )
#line 84
{
  LedsP$Led0$toggle();
...
static inline void BlinkC$Timer0$fired(void )
{
  sim_log_debug(149U, "BlinkC", "Timer 0 fired @ %s.\n", sim_time_string());
...
{
  LedsP$Led1$toggle();
  sim_log_debug(158U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 101
  ;
}
...
static inline void BlinkC$Timer1$fired(void )
{
  sim_log_debug(150U, "BlinkC", "Timer 1 fired @ %s \n", sim_time_string());
...
#line 42
# 114 "/home/ubuntu1310/tinyos-main/tos/system/LedsP.nc"
static inline void LedsP$Leds$led2Toggle(void )
#line 114
{
  LedsP$Led2$toggle();
  sim_log_debug(161U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 116
  ;
}

# 100 "/home/ubuntu1310/tinyos-main/tos/interfaces/Leds.nc"
...
static inline void BlinkC$Timer2$fired(void )
{
  sim_log_debug(151U, "BlinkC", "Timer 2 fired @ %s.\n", sim_time_string());
...
# 83 "/home/ubuntu1310/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2ac412b14c28){
#line 83
  switch (arg_0x2ac412b14c28) {
#line 83
    case 0U:
#line 83
      BlinkC$Timer0$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2ac412b14c28);
#line 83
      break;
#line 83
    }
...
#line 57
  {
    sim_log_debug(152U, "Init", "LEDS: initialized.\n");
...
static inline void BlinkC$Boot$booted(void )
{
  sim_log_debug(148U, "BlinkC", "booted \n");
...
# 154 "/home/ubuntu1310/tinyos-main/tos/lib/timer/VirtualizeTimerC.nc"
static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(uint8_t num, uint32_t dt)
{
