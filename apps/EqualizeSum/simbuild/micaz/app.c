...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x2b56488b1cf8, const void *arg_0x2b56488b0020);
#line 775
__extension__ 
#line 792
__extension__ 
...
#line 251
extern double erfc(double arg_0x2b5648932618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x2b5648b828e8), 
int (*key_eq_fn)(void *arg_0x2b5648b800c8, void *arg_0x2b5648b80368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b5648d91610, int arg_0x2b5648d91878);
static double RandomUniform(void );
...
EqualizeSumC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint16_t EqualizeSumC$local1[1000];
uint16_t EqualizeSumC$local2[1000];
uint16_t EqualizeSumC$local3[1000];
uint32_t EqualizeSumC$localSum[1000];
uint32_t EqualizeSumC$remoteSum[1000];
bool EqualizeSumC$busy[1000];

static inline void EqualizeSumC$sendMessage(void );
#line 49
static inline void EqualizeSumC$processReceivedNumbers(uint16_t n1, uint16_t n2, uint16_t n3);
#line 65
static inline void EqualizeSumC$Boot$booted(void );




static inline void EqualizeSumC$SplitControl$startDone(error_t err);
...
static inline void EqualizeSumC$SplitControl$stopDone(error_t err);



static void EqualizeSumC$AMSend$sendDone(message_t *msg, error_t err);
...
am_addr_t addr);
#line 162
static void /*EqualizeSumAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
#line 49
{
  sim_log_debug(150U, "EqualizeSumC", "Received %d, %d and %d \n", n1, n2, n3);
  EqualizeSumC$remoteSum[sim_node()] = n1 + n2 + n3;
  if (EqualizeSumC$localSum[sim_node()] >= EqualizeSumC$remoteSum[sim_node()]) {
      sim_log_debug(151U, "EqualizeSumC", "Local Sum(%d) is greater than or equal to Remote Sum(%d), so doing nothing \n", EqualizeSumC$localSum[sim_node()], EqualizeSumC$remoteSum[sim_node()]);
    }
  else {
      sim_log_debug(152U, "EqualizeSumC", "Local Sum(%d) is less that Remote Sum(%d) \n", EqualizeSumC$localSum[sim_node()], EqualizeSumC$remoteSum[sim_node()]);
      EqualizeSumC$local1[sim_node()] = n1;
      EqualizeSumC$local2[sim_node()] = n2;
      EqualizeSumC$local3[sim_node()] = n3;
      EqualizeSumC$localSum[sim_node()] = EqualizeSumC$local1[sim_node()] + EqualizeSumC$local2[sim_node()] + EqualizeSumC$local3[sim_node()];
      sim_log_debug(153U, "EqualizeSumC", "New local numbers are %d, %d and %d, Sum = %d \n", EqualizeSumC$local1[sim_node()], EqualizeSumC$local2[sim_node()], EqualizeSumC$local3[sim_node()], EqualizeSumC$localSum[sim_node()]);
    }
}
...
#line 96
      EqualizeSumC$processReceivedNumbers(__nesc_ntoh_uint16(espkt->n1.nxdata), __nesc_ntoh_uint16(espkt->n2.nxdata), __nesc_ntoh_uint16(espkt->n3.nxdata));
    }
  return msg;
}
...
# 78 "/home/tharun/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b564917f340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b564917f340) {
#line 78
    case 7:
#line 78
      __nesc_result = EqualizeSumC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b564917f340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tharun/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b564917e020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b564917e020, msg, payload, len);
#line 78
...
# 80 "/home/tharun/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b56493b4020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b56493b4020, addr, msg, len);
#line 80
...
#line 55
{
  /*EqualizeSumAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*EqualizeSumAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 7);
...
#line 80
  __nesc_result = /*EqualizeSumAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 27
{
  sim_log_debug(148U, "EqualizeSumC", "Sending Message at time: %s \n", sim_time_string());
  if (!EqualizeSumC$busy[sim_node()]) {
      EqualizeSumMsg *espkt = (EqualizeSumMsg *)EqualizeSumC$Packet$getPayload(&EqualizeSumC$pkt[sim_node()], sizeof(EqualizeSumMsg ));

#line 31
      __nesc_hton_uint16(espkt->nodeid.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(espkt->n1.nxdata, EqualizeSumC$Random$rand16());
      __nesc_hton_uint16(espkt->n2.nxdata, EqualizeSumC$Random$rand16());
      __nesc_hton_uint16(espkt->n3.nxdata, EqualizeSumC$Random$rand16());
      EqualizeSumC$local1[sim_node()] = __nesc_ntoh_uint16(espkt->n1.nxdata);
      ...
      if (EqualizeSumC$AMSend$send(AM_BROADCAST_ADDR, &EqualizeSumC$pkt[sim_node()], sizeof(EqualizeSumMsg )) == SUCCESS) {
          EqualizeSumC$busy[sim_node()] = TRUE;
        }
    }
}
...
{
  if (err == SUCCESS) {
      sim_log_debug(155U, "EqualizeSumC", "Component started at %s \n", sim_time_string());
      EqualizeSumC$sendMessage();
    }
  else {
...
# 110 "/home/tharun/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b5649180220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b5649180220, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tharun/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b56493b6e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b56493b6e18) {
#line 100
    case 0U:
#line 100
      /*EqualizeSumAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b56493b6e18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tharun/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b5648e93108){
#line 75
  switch (arg_0x2b5648e93108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b5648e93108);
#line 75
      break;
#line 75
    }
...
#line 65
{
  sim_log_debug(154U, "EqualizeSumC", "Booted node: %d at %s \n", TOS_NODE_ID, sim_time_string());
  EqualizeSumC$SplitControl$start();
}
...
#line 84
{
  if (err == FAIL || err == ECANCEL) {
      sim_log_debug(157U, "EqualizeSumC", "Sending error at %s \n", sim_time_string());
    }
  if (&EqualizeSumC$pkt[sim_node()] == msg) {
      EqualizeSumC$busy[sim_node()] = FALSE;
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module EqualizeSumC */
  if (!strcmp(varname, "EqualizeSumC$pkt"))
  {
    *addr = (uintptr_t)&EqualizeSumC$pkt[__nesc_mote];
    *size = sizeof(EqualizeSumC$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EqualizeSumC$local1"))
  {
    *addr = (uintptr_t)&EqualizeSumC$local1[__nesc_mote];
    *size = sizeof(EqualizeSumC$local1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EqualizeSumC$local2"))
  {
    *addr = (uintptr_t)&EqualizeSumC$local2[__nesc_mote];
    *size = sizeof(EqualizeSumC$local2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EqualizeSumC$local3"))
  {
    *addr = (uintptr_t)&EqualizeSumC$local3[__nesc_mote];
    *size = sizeof(EqualizeSumC$local3[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EqualizeSumC$localSum"))
  {
    *addr = (uintptr_t)&EqualizeSumC$localSum[__nesc_mote];
    *size = sizeof(EqualizeSumC$localSum[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EqualizeSumC$remoteSum"))
  {
    *addr = (uintptr_t)&EqualizeSumC$remoteSum[__nesc_mote];
    *size = sizeof(EqualizeSumC$remoteSum[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EqualizeSumC$busy"))
  {
    *addr = (uintptr_t)&EqualizeSumC$busy[__nesc_mote];
    *size = sizeof(EqualizeSumC$busy[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module EqualizeSumC */
  memset((void *)&EqualizeSumC$pkt[__nesc_mote], 0, sizeof EqualizeSumC$pkt[__nesc_mote]);
  memset((void *)&EqualizeSumC$local1[__nesc_mote], 0, sizeof EqualizeSumC$local1[__nesc_mote]);
  memset((void *)&EqualizeSumC$local2[__nesc_mote], 0, sizeof EqualizeSumC$local2[__nesc_mote]);
  memset((void *)&EqualizeSumC$local3[__nesc_mote], 0, sizeof EqualizeSumC$local3[__nesc_mote]);
  memset((void *)&EqualizeSumC$localSum[__nesc_mote], 0, sizeof EqualizeSumC$localSum[__nesc_mote]);
  memset((void *)&EqualizeSumC$remoteSum[__nesc_mote], 0, sizeof EqualizeSumC$remoteSum[__nesc_mote]);
  EqualizeSumC$busy[__nesc_mote] = FALSE;
